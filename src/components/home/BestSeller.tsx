...
interface BestSellerProps {
  data?: { id: string; product_src: string; product_name: string }[]; // Array of objects
}

const BestSeller: FC<BestSellerProps> = ({ data = [] }) => {
  if (data.length === 0) return null; // Avoid rendering if empty
  ...
  return (
    <div className="bg-black text-[#F8C900] p-6 flex flex-col items-center font-poppins">
      {/* Heading */}
      <h1 className="text-3xl font-bold mb-6">BEST SELLER</h1>
